<%-- 
    Document   : index
    Created on : 27 sep 2021, 8:08:58
    Author     : JMTN
--%>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="categorias/nuevaCategoria.jsp">Nueva categoría</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="productos/ListaDeProductos.jsp">Listado de productos</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="productos/nuevoProducto.jsp">Nuevo productos</a>
                            </li>
                        </ul>
                    </div>
                </div>
